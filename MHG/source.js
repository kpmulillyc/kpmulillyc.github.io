...
},{"./APIWrapper":2,"./base":8,"./models":51}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MHG = exports.MHGInfo = exports.MHG_IMAGE_BASE_URL = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const MHGParser_1 = require("./MHGParser");
const MHG_DOMAIN = 'https://tw.manhuagui.com';
exports.MHG_IMAGE_BASE_URL = 'https://i.hamreus.com';
exports.MHGInfo = {
    version: '1.0.1',
    name: 'ManHuaGui',
...
class MHG extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        this.requestManager = createRequestManager({
            ...
            interceptor: {
                ...
                interceptResponse: (response) => __awaiter(this, void 0, void 0, function* () {
                    var _c;
                    response['fixedData'] = (_c = response.data) !== null && _c !== void 0 ? _c : Buffer.from(createByteArray(response.rawData)).toString();
                    return response;
                })
            }
        });
        this.baseUrl = MHG_DOMAIN;
        this.parser = new MHGParser_1.Parser();
    }
    ...
    getChapterDetails(mangaId, chapterId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load((_b = data.data) !== null && _b !== void 0 ? _b : data['fixedData']);
...
},{"./MHGParser":53,"buffer":3,"paperback-extensions-common":9}],53:[function(require,module,exports){
"use strict";
...
class Parser {
    parseMangaDetails($, mangaId) {
        ...
        const image = (_b = 'http://' + ((_a = $('p.hcover > img').attr('src')) === null || _a === void 0 ? void 0 : _a.replace('//', ''))) !== null && _b !== void 0 ? _b : '';
    ...
    parseChapterList($, mangaId) {
        ...
        chapArray.forEach((obj) => {
            ...
            const chapNum = parseFloat((_d = ((_c = chapName.match(/[\d.]+/)) !== null && _c !== void 0 ? _c : ['0'])[0]) !== null && _d !== void 0 ? _d : '0');
    ...
    parseChapterDetails($) {
        ...
        if (htmlMatch !== undefined && htmlMatch[1] !== undefined && htmlMatch[2] !== undefined && htmlMatch[3] !== undefined && htmlMatch[4] !== undefined)
            tmp = this.decode(htmlMatch[1], htmlMatch[2], htmlMatch[3], (_a = lz_string_1.default.decompressFromBase64(htmlMatch[4])) === null || _a === void 0 ? void 0 : _a.split('|'));
        ...
        for (const index in jsonObj.files)
            pages.push(`${MHG_1.MHG_IMAGE_BASE_URL}${path}/${jsonObj.files[index]}?e=${jsonObj.sl.e}&m=${jsonObj.sl.m}`);
        return pages;
    }
    decode(p, a, c, k, e = 0, d = {}) {
        e = function (c) { return (c < a ? '' : e(Math.floor(c / a))) + ((c = c % a) > 35 ? String.fromCharCode(c + 29) : c.toString(36)); };
        if (!''.replace(/^/, String)) {
            while (c--)
                d[e(c)] = k[c] || e(c);
    ...
    parseHomeSections($, sectionCallback) {
        const section1 = createHomeSection({ id: '1', title: '熱門連載漫畫', type: paperback_extensions_common_1.HomeSectionType.singleRowLarge, view_more: false });
        const section6 = createHomeSection({ id: '6', title: '日排行', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section7 = createHomeSection({ id: '7', title: '週排行', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section8 = createHomeSection({ id: '8', title: '月排行', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section2 = createHomeSection({ id: '2', title: '少女/愛情', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section3 = createHomeSection({ id: '3', title: '少年/熱血', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section4 = createHomeSection({ id: '4', title: '競技/體育', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section5 = createHomeSection({ id: '5', title: '武俠/格鬥', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
    ...
    handleHomeSection($, className, start, end) {
        var _a;
        ...
        for (let index = start; index < end; index++) {
            const title = $(bookList[index]).attr('alt');
            const match = (_a = $(bookList[index]).attr(src)) === null || _a === void 0 ? void 0 : _a.match(/\/\/cf.hamreus.com\/.+\/.+\/(\d*|\d*_\d*).jpg/);
    ...
    handleRankingSection($, start, end) {
        const tiles = [];
        const ulArray = $('div#rankCont');
        const bookList = $('li > h6', ulArray).toArray();
        for (let index = start; index < end; index++) {
            const title = $(bookList[index]).children().attr('title');
    ...
    parseSearchResult($) {
        ...
        for (let index = 0; index < mangaArray.length; index++) {
            const title = $(mangaArray[index]).children().first().text();
...
},{"./MHG":52,"lz-string":5,"paperback-extensions-common":9}]},{},[52])(52)
});
